...
const baseCreateAuctionSchema = z.object({
  ...
  description: z.string().min(50, 'Description must be at least 50 characters').max(4000, 'Description too long'),
...
export const createAuctionSchema = baseCreateAuctionSchema.refine((data) => {
