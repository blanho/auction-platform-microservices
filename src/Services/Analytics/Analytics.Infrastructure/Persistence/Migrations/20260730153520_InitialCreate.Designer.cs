...
namespace Analytics.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260730153520_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Analytics.Domain.Entities.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Analytics.Domain.Entities.DailyAuctionStats", b =>
                {
            ...
            modelBuilder.Entity("Analytics.Domain.Entities.DailyBidStats", b =>
                {
                    b.Property<DateOnly>("DateKey")
                        .HasColumnType("date")
                        .HasColumnName("date_key");
            ...
            modelBuilder.Entity("Analytics.Domain.Entities.DailyRevenueStats", b =>
                {
                    b.Property<DateOnly>("DateKey")
                        .HasColumnType("date")
                        .HasColumnName("date_key");
            ...
            modelBuilder.Entity("Analytics.Domain.Entities.FactAuction", b =>
                {
            ...
            modelBuilder.Entity("Analytics.Domain.Entities.FactBid", b =>
                {
                    b.Property<Guid>("EventId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Analytics.Domain.Entities.FactPayment", b =>
                {
                    b.Property<Guid>("EventId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Analytics.Domain.Entities.FactUser", b =>
                {
                    b.Property<Guid>("EventId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("fact_users", "analytics");
                });

            modelBuilder.Entity("Analytics.Domain.Entities.PlatformSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Analytics.Domain.Entities.Report", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
