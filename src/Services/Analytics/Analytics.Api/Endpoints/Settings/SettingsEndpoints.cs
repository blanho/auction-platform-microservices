...
using Analytics.Application.Features.PlatformSettings.BulkUpdateSettings;
using Analytics.Application.Features.PlatformSettings.CreateSetting;
using Analytics.Application.Features.PlatformSettings.DeleteSetting;
using Analytics.Application.Features.PlatformSettings.GetSettingById;
using Analytics.Application.Features.PlatformSettings.GetSettingByKey;
using Analytics.Application.Features.PlatformSettings.GetSettings;
using Analytics.Application.Features.PlatformSettings.UpdateSetting;
using Analytics.Domain.Enums;
using BuildingBlocks.Web.Authorization;
using BuildingBlocks.Web.Extensions;
using BuildingBlocks.Web.Helpers;

namespace Analytics.Api.Endpoints.Settings;
