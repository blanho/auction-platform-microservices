        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    unique_sellers = table.Column<long>(type: "bigint", nullable: false),
                    unique_winners = table.Column<long>(type: "bigint", nullable: false),
                    total_revenue = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    avg_sale_price = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    min_sale_price = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    max_sale_price = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    sold_count = table.Column<long>(type: "bigint", nullable: false),
                    unsold_count = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_daily_auction_stats", x => new { x.date_key, x.event_type });
                });

            migrationBuilder.CreateTable(
                name: "daily_bid_stats",
                schema: "analytics",
                columns: table => new
                {
                    date_key = table.Column<DateOnly>(type: "date", nullable: false),
                    total_bids = table.Column<long>(type: "bigint", nullable: false),
                    unique_bidders = table.Column<long>(type: "bigint", nullable: false),
                    auctions_with_bids = table.Column<long>(type: "bigint", nullable: false),
                    total_bid_value = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    avg_bid_amount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    min_bid_amount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    max_bid_amount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_daily_bid_stats", x => x.date_key);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    unique_buyers = table.Column<long>(type: "bigint", nullable: false),
                    unique_sellers = table.Column<long>(type: "bigint", nullable: false),
                    total_revenue = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    avg_transaction_amount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    refunded_amount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    refund_count = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_daily_revenue_stats", x => new { x.date_key, x.event_type });
                });
