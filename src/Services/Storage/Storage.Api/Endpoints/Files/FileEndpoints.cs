...
public class FileEndpoints : ICarterModule
{
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        group.MapPost("/presigned-upload/confirm", ConfirmPresignedUpload)
            .WithName("ConfirmPresignedUpload")
            .WithSummary("Confirm a presigned upload after the client has uploaded directly")
            .WithOpenApi()
            .RequireAuthorization(new RequirePermissionAttribute(Permissions.Storage.Upload));
