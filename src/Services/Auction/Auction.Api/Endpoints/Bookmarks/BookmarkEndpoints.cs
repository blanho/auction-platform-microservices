...
using Auctions.Application.Features.Bookmarks.AddToWatchlist;
using Auctions.Application.Features.Bookmarks.RemoveFromWatchlist;
using Auctions.Application.Features.Bookmarks.UpdateBookmarkNotifications;
using Auctions.Application.DTOs;
using Auctions.Application.Features.Bookmarks.GetBookmark;
using Auctions.Application.Features.Bookmarks.GetWatchlist;
using Auctions.Application.Features.Bookmarks.GetWatchlistCount;
using Auctions.Application.Features.Bookmarks.IsInWatchlist;
