        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SellerUsername = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    WinnerId = table.Column<Guid>(type: "uuid", nullable: true),
                    WinnerUsername = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuyerUsername = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    SellerId = table.Column<Guid>(type: "uuid", nullable: false),
                    SellerUsername = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    BuyNowPrice = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    ItemTitle = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuyNowSagaStates", x => x.CorrelationId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotifyOnBid = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    NotifyOnEnd = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewerUsername = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    ReviewedUserId = table.Column<Guid>(type: "uuid", nullable: false),
                    ReviewedUsername = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Auctions_IsDeleted_Status",
                table: "Auctions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Auctions_SellerUsername",
                table: "Auctions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Auctions_Status_AuctionEnd",
                table: "Auctions",
                columns: new[] { "Status", "AuctionEnd" });

            migrationBuilder.CreateIndex(
                name: "IX_Auctions_Status_IsFeatured",
                table: "Auctions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookmarks_UserId_AuctionId_Type",
                table: "Bookmarks",
                columns: new[] { "UserId", "AuctionId", "Type" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BuyNowSagaStates_AuctionId",
                table: "BuyNowSagaStates",
                column: "AuctionId");

            migrationBuilder.CreateIndex(
                name: "IX_BuyNowSagaStates_BuyerId",
                table: "BuyNowSagaStates",
                column: "BuyerId");

            migrationBuilder.CreateIndex(
                name: "IX_BuyNowSagaStates_CurrentState",
                table: "BuyNowSagaStates",
                column: "CurrentState");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_AuctionId_ReviewerId",
                table: "Reviews",
                columns: new[] { "AuctionId", "ReviewerId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_ReviewerUsername",
                table: "Reviews",
