    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAuctionBookmarks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserAuctionBookmarks_Auctions_AuctionId",
                        column: x => x.AuctionId,
                        principalTable: "Auctions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAuctionBookmarks_Type",
                table: "UserAuctionBookmarks",
                column: "Type");

            migrationBuilder.CreateIndex(
                name: "IX_UserAuctionBookmarks_UserId",
                table: "UserAuctionBookmarks",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserAuctionBookmarks_UserId_AuctionId_Type",
                table: "UserAuctionBookmarks",
                columns: new[] { "UserId", "AuctionId", "Type" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserAuctionBookmarks_Username",
                table: "UserAuctionBookmarks",
                column: "Username");
        }
