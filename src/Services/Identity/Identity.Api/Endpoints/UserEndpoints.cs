...
public class UserEndpoints : ICarterModule
{
    ...
    private static async Task<IResult> GetSellerStatus(System.Security.Claims.ClaimsPrincipal user, ISender sender, CancellationToken cancellationToken)
    {
    ...
    private static async Task<IResult> ApplyForSeller([FromBody] BecomeSellerRequest request, System.Security.Claims.ClaimsPrincipal user, ISender sender, CancellationToken cancellationToken)
    {
        var userId = user.GetRequiredUserIdString();
