...
public class TwoFactorEndpoints : ICarterModule
{
    ...
    private static async Task<IResult> GetStatus(System.Security.Claims.ClaimsPrincipal user, ISender sender, CancellationToken cancellationToken)
    {
    ...
    private static async Task<IResult> SetupAuthenticator(System.Security.Claims.ClaimsPrincipal user, ISender sender, CancellationToken cancellationToken)
    {
        var userId = user.GetRequiredUserIdString();
    ...
    private static async Task<IResult> EnableAuthenticator([FromBody] Enable2FARequest request, System.Security.Claims.ClaimsPrincipal user, ISender sender, CancellationToken cancellationToken)
    {
        var userId = user.GetRequiredUserIdString();
    ...
    private static async Task<IResult> DisableAuthenticator([FromBody] Disable2FARequest request, System.Security.Claims.ClaimsPrincipal user, ISender sender, CancellationToken cancellationToken)
    {
        var userId = user.GetRequiredUserIdString();
    ...
    private static async Task<IResult> GenerateRecoveryCodes(System.Security.Claims.ClaimsPrincipal user, ISender sender, CancellationToken cancellationToken)
    {
        var userId = user.GetRequiredUserIdString();
