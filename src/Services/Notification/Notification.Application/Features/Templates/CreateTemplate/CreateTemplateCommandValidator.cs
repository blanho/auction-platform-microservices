...
public class CreateTemplateCommandValidator : AbstractValidator<CreateTemplateCommand>
{
    public CreateTemplateCommandValidator()
    {
        RuleFor(x => x.Key)
            ...
            .MaximumLength(NotificationDefaults.Template.KeyMaxLength).WithMessage(ValidationConstants.Messages.MaxLength("Template key", NotificationDefaults.Template.KeyMaxLength));
